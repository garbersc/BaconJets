...
void CorrectionObject::FinalControlPlots_CorrectFormulae(){
  ...
  for(int i=0; i<n_eta-1; i++){
    ...
    TLegend leg7 = tdrLeg(0.45,0.46,0.70,0.81);
    ...
    TLegend leg8 = tdrLeg(0.45,0.46,0.70,0.81);
    ...
    TLegend leg9 = tdrLeg(0.45,0.46,0.70,0.81);
    ...
    TLegend leg10 = tdrLeg(0.45,0.46,0.70,0.81);
    ...
    TLegend leg11 = tdrLeg(0.45,0.46,0.70,0.81);
    ...
    TLegend leg12 = tdrLeg(0.45,0.46,0.70,0.81);
    ...
    TLegend leg13 = tdrLeg(0.45,0.46,0.70,0.81);
    ...
    TLegend leg14 = tdrLeg(0.45,0.46,0.70,0.81);
